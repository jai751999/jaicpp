...
class BookTest(TestCase):
    ...
    def test_book_list_view_for_logged_in_user(self):
        self.client.login(username = 'jai', email='jai751999gmail.com', password='secret')
    ...
    def test_book_detail_view_for_logged_in_user(self):
        self.client.login(username = 'jai', email='jai751999@gmail.com', password='secret')
